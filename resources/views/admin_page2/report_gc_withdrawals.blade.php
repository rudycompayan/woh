                ...
                <div class="row">
                    <div class="span12">
                        <div class="widget widget-table action-table" id="print-element">
                            <form action="{{action('AdminController@post_filter_gc_withdrawals')}}" method="post">
                                <div class="widget-header"> <i class="icon-th-list"></i>
                                    <h3>GC Withdrawals Report</h3>
                                    ...
                                    @if(isset($gc))
                                        @foreach($gc as $g)
                                            <tr>
                                                ...
                                                <td>{!! \Carbon\Carbon::parse($g['date_claim'])->format('m/d/Y h:i A') !!}</td>
